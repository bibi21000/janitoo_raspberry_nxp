...
janitoo_entry_points = {
    "janitoo.threads": [
        "rpinxp = janitoo_raspberry_nxp.thread_nxp:make_thread",
    ],
    "janitoo.components": [
        "rpinxp.reader = janitoo_raspberry_nxp.nxp:make_reader",
        "rpinxp.writer = janitoo_raspberry_nxp.nxp:make_writer",
    ],
}

setup(
    name = 'janitoo_raspberry_nxp',
